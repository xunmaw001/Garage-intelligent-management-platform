...
<body>
        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-assist">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">车库推荐</span>
          ...
          <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
            <div class="ng-incontlst-doc ng-incontlst-doc-show">
              <div class="row">
                <div class="ng-incontlst-col" v-for="(item,index) in chekuRecommend" v-bind:key="index">
                  <div class="ng-incontlst-bor">
                    <div class="ng-incontlst-img ng-oa ng-fault">
                      <a href="javascript:void(0);" @click="jump('../cheku/detail.jsp?id='+item.id)">
                    ...
                    <div class="ng-fault ng-container">
                      ...
                      <a href="javascript:void(0);" class="ng-incontlst-ikk" @click="jump('../cheku/detail.jsp?id='+item.id)">查看详情</a>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-assist">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">平台新闻</span>
  ...
  <script type="text/javascript">
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      // 获取推荐信息
      http.request(`cheku/page`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.chekuRecommend = res.data.list;
        vue.$nextTick(()=>{
          window.xznResize();
        });
      });
              
      http.request(`chekuzixun/page`, 'get', {
        page: 1,
        limit: 10
      }, function(res) {
