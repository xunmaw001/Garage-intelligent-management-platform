                  ...
                  <div class="ng-newbve">
                    <div class="ng-newbve-img ">
                      <div class="ng-newbve-img-ikk ng-oa ng-container">
                        <a href="javascript:void(0);" @click="jump('../news/detail.jsp?id='+item.id);"><img :src="item.imgPhoto"/></a>
                      </div>
                    </div>
                    <div class="ng-newbve-iff">
                      <div class="ng-newbve-itit" @click="jump('../news/detail.jsp?id='+item.id);">{{item.zixunbiaoti}}</div>
                      <div class="ng-newbve-itime">{{item.addtime}}</div>
                      <div class="ng-newbve-text">{{item.zixunneirongContent|newsDesc}}...</div>
