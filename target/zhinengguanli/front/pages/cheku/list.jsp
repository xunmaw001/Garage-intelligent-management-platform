        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-fff">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">车库展示</span><span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
            </div>
            ...
            <form class="layui-form">
              <div class="layui-inline" style="margin-bottom: 10px;">
                ...
                <div class="layui-input-inline">
                  <input type="text" name="name" id="name" placeholder="车库名称" autocomplete="off" class="layui-input">
                </div>
              </div>   
              <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
                ...
                <button v-if="isAuth('cheku','新增')" @click="jump('../cheku/add.jsp')" type="button" class="layui-btn btn-theme">
              ...
              <ul>
                <li v-for="(item,index) in dataList" v-bind:key="index">
                  <div class="ng-prslist-doc">
                    <div class="ng-prslist-img" @click="jump('../cheku/detail.jsp?id='+item.id)">
                      <a href="#" class="ng-prsliik">
                        <span class="ng-prsliik-ki ng-prsliik-ki_1">
                          <img :src="item.imgPhoto" />
                        </span>
                    ...
                    <div class="ng-prslist-tit" @click="jump('../cheku/detail.jsp?id='+item.id)"><span>{{item.name}}</span></div>
                    <div class="ng-prslist-tit" v-if="item.money"><span style="color: red;">{{item.money}} RMB</span></div>
                  </div>
                </li>
              </ul>
            </div>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        // 获取列表数据
        http.request('cheku/page', 'get', param, function(res) {
